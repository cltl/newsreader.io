---
layout: page
title: "The ECB+ Corpus"
permalink: /results/data/the-ecb-corpus/
---
...
- non-human participants (annotation tags starting with NON\_HUMAN)
...
The data can be downloaded from: https://github.com/cltl/ecbPlus

**CONTENTS**

- 982 ECB+ corpus texts in the XML format: ECB+.zip
- ECB+ annotation guideline: NWR-2014-1.pdf
- Index of sentences annotated with coreference: ECBplus\_coreference\_sentences.csv (see README.TXT)
- LICENSEDATA.TXT
- COPYING-CC.TXT
- README.TXT.
